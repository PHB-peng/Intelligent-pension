...
/* 13 */
/*!********************************************************************!*\
  !*** D:/uniapptest/test3/main.js?{"page":"pages%2Findex%2Findex"} ***!
  \********************************************************************/
...
/* 14 */
/*!*************************************************!*\
  !*** D:/uniapptest/test3/pages/index/index.vue ***!
  \*************************************************/
/*! no static exports found */
...
/* 15 */
/*!********************************************************************************!*\
  !*** D:/uniapptest/test3/pages/index/index.vue?vue&type=template&id=57280228& ***!
  \********************************************************************************/
...
/* 17 */
/*!**************************************************************************!*\
  !*** D:/uniapptest/test3/pages/index/index.vue?vue&type=script&lang=js& ***!
  \**************************************************************************/
/*! no static exports found */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var _default =
{
  ...
  methods: {
    CommodityData: function CommodityData() {var _this = this;return _asyncToGenerator( /*#__PURE__*/_regenerator.default.mark(function _callee() {var CommodityList;return _regenerator.default.wrap(function _callee$(_context) {while (1) {switch (_context.prev = _context.next) {case 0:_context.next = 2;return (
                  _this.$json.CommodityList);case 2:CommodityList = _context.sent;
                CommodityList.forEach(function (item, i) {
                  item.number = 0;
                });
                _this.CommodityList = CommodityList;
                setTimeout(function () {
                  uni.hideLoading();
                }, 500);case 6:case "end":return _context.stop();}}}, _callee);}))();
    },

    NumberbBox: function NumberbBox(index) {var _this2 = this; //添加关闭购物车
      var times = null;
      if (this.flag) {
    ...
    sub: function sub(index) {//减少购物车
      if (this.CommodityList[index].number <= 1) return;
      this.CommodityList[index].number--;
      this.getGoodsList(this.CommodityList[index]);

    },
    add: function add(index) {//增加购物车
      if (this.CommodityList[index].number >= this.CommodityList[index].stock) return;
      this.CommodityList[index].number++;
      this.getGoodsList(this.CommodityList[index]);

    },
    getGoodsList: function getGoodsList(CommodityList) {var _this3 = this;
      var goodsList = this.$msg.fetchCache(this.$msg.CARTLIST) || []; //读取缓存
      var listfalg = null;
      var listindex = null;
      var len1 = goodsList.length;
      if (len1 == 0) {
        listfalg = 3;
        ...
        i) {//遍历购物车信息
          if (goodsList[i].firmId == CommodityList.firmId) {//如果存在同一id商家
            goodsList[i].goods.forEach(function (item, j) {
            ...
            listfalg = 3;
          }};for (var i = 0; i < len1; i++) {var _ret = _loop(i);if (_ret === "break") break;

        }
      }
      setTimeout(function () {
        var item = CommodityList;
        //存在同一商品id 直接将赋值
        if (listfalg == 1) {//存在同一商品id 直接将赋值
          ...
          var _i = goodsList.length - 1;
          goodsList[_i].goods.push({
            id: item.id,
            image: item.image,
            attr_val: item.attr_val,
            stock: item.stock,
        ...
        _this3.$msg.updateCache(_this3.$msg.CARTLIST, goodsList); //存入缓存
      }, 300);
...
/* 22 */
/*!***********************************************************************************!*\
  !*** D:/uniapptest/test3/pages/index/index.vue?vue&type=style&index=0&lang=less& ***!
  \***********************************************************************************/
/*! no static exports found */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
